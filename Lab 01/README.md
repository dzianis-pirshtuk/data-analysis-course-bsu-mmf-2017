...
Задание появится 7-го сентября. Срок выполния будет оглашен позже. На первом неделе нужно разобраться с уставкой и запуском Jupyter Notebook и прочитать следующие материалы.
